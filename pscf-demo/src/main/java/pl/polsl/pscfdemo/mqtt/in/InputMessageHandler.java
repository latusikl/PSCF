...
public class InputMessageHandler implements MessageHandler {
	...
	final DataMemoryService dataMemoryService;

	public InputMessageHandler(final ObjectMapper objectMapper, final DataMemoryService dataMemoryService) {
	...
	public void handleMessage(final Message<?> message) throws MessagingException {
		...
		try {
			dataMemoryService.addMeasurement(objectMapper.readValue(messageBody, InputBrokerDto.class));
